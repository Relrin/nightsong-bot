...
mod tests {
    ...
    fn test_get_error_for_invalid_owner_on_deletion() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("For deleting this giveaway you need to be its owner.".to_string())
        );
    }
    ...
    fn test_get_error_for_invalid_owner_on_activate() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("For interacting with this giveaway you need to be its owner.".to_string())
        );
    }
    ...
    fn test_get_error_for_inactive_giveaway_on_roll_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("The giveaway hasn't started yet or has been suspended by the owner.".to_string())
        );
    }
    ...
    fn test_get_error_for_already_activated_reward_on_confirm_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("The reward has been activated already.".to_string())
        );
    }
    ...
    fn test_get_error_for_invalid_user_on_confirm_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("This reward can't be activated by others.".to_string())
        );
    }
    ...
    fn test_get_error_for_unused_reward_on_confirm_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("The reward must be rolled before confirming.".to_string())
        );
    }
    ...
    fn test_get_error_for_invalid_user_on_deny_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("This reward can't be returned by others.".to_string())
        );
    }
    ...
    fn test_get_error_for_unused_reward_on_deny_reward() {
        ...
        assert_eq!(
            result.unwrap_err(),
            Error::Giveaway("The reward must be rolled before return.".to_string())
        );
    }
